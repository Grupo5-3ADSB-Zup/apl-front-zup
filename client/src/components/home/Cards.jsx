      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='w-full shadow-xl bg-[#013440] flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
              ...
              <div className='text-center font-medium'>
                  <p className='text-[White] py-2 border-b mx-8'>Utilizando uma tecnologia para cruzamento de dados, entregaremos informações de diversas fontes, reunidas em um só lugar com a maior assertividade do mercado!
                  </p>
              </div>
          ...
          <div className='w-full shadow-xl bg-[#013440] flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
              <h2 className='text-[#F2CB05] text-2xl font-bold text-center py-8'>Interação entre usuários</h2>
              <div className='text-center font-medium'>
                  <p className='text-[White] py-2 border-b mx-8'>E como tudo que é compartilhado fica melhor, você também poderá iniciar conversas pelos comentarios das publicações!
                  </p>
              </div>
